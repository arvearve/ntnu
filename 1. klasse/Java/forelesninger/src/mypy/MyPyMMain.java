...
public class MyPyMMain extends ConsoleProgram {
	...
	// main er Java sin standard oppstartsfunksjon, args er String-tabell som inneholder program-argumentene
	public static void main(String[] args) {
		// vi oppretter program-objekt vårt og kaller start-metoden, som er definert i ConsoleProgram, som vi bygger på
		new MyPyMMain().start(args);
	}
}
